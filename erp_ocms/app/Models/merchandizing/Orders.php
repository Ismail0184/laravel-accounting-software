...
class Orders extends Model  {
     ...
     * @var array
     */
    protected $fillable = ['jobno', 'orderno', 'style', 'buyer_id', 'mt_id', 'item', 'currency_id', 'price', 'bd_id', 'fabrication', 'm_id', 'years', 'incoterm_id', 'lc_mod_id', 'commercial', 'com_id','user_id'];
