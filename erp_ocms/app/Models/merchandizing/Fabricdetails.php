...
class Fabricdetails extends Model  {
     ...
     * @var string
     */
    protected $table = 'merch_fabricdetails';
     ...
     * @var array
     */
    protected $fillable = ['fm_id','jobno','pono', 'breakdown_id', 'booking_id','gtype_id', 'pogarment_id', 'dia_sl', 'diatype_id', 'dia_id', 'structure_id', 'gsm_id', 'ftype_id', 'unit_id', 'ytype_id', 'ycount_id', 'yconsumption_id', 'elasten' ,'lycraratio_id', 'ydstripe_id', 'ydrepeat', 'finishing_id','washing_id', 'ccuff_id', 'aop_id',  'cprocess_id','color','consumption','wastage','loss','com_id','user_id'];
