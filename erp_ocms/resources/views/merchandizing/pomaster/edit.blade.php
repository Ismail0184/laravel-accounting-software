...
@section('htmlheader_title', $langs['edit'] . ' Pomaster')

@section('contentheader_title', $langs['edit'] . ' Pomaster')
...
@section('main-content')
 <div class="box">
    ...
    {!! Form::model($pomaster, ['route' => ['pomaster.update', $pomaster->id], 'method' => 'PATCH', 'class' => 'form-horizontal pomaster']) !!}
