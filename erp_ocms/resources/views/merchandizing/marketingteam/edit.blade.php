...
@section('htmlheader_title', $langs['edit'] . ' Marketingteam')

@section('contentheader_title', $langs['edit'] . ' Marketingteam')

@section('main-content')
    
    {!! Form::model($marketingteam, ['route' => ['marketingteam.update', $marketingteam->id], 'method' => 'PATCH', 'class' => 'form-horizontal marketingteam']) !!}
