...
@section('htmlheader_title', $langs['create_new'] . ' Fabricmaster')

@section('contentheader_title', $langs['create_new'] . ' DIA')
...
<div class="container">
    ...
    {!! Form::open(['route' => 'fabricmaster.store', 'class' => 'form-horizontal fabricmaster']) !!}
					...
					<div class="form-group col-sm-2">
                        ...
                        <div class=""> 
                            ...
                            {!! Form::hidden('jobno', $jobno, null, ['class' => 'form-control', 'required']) !!}
                            {!! Form::hidden('booking_id', $booking_id, null, ['class' => 'form-control', 'required']) !!}
                            {!! Form::hidden('dia_sl', $dia_sl, null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
					<div class="form-group col-sm-2">
