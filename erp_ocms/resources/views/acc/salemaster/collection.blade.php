...
@section('contentheader_title', 'Collection')

@section('main-content')

    <div class="box">
        <div class="box-header">
            <a href="{{ url('salemaster/collection_print') }}" title="{{ $langs['print'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-print"></i></a>
        </div><!-- /.box-header -->
        <div class="box-body">
            <table id="empolyee-table" class="table table-bordered table-striped">
                <thead>
                <tr><td colspan="4"><a href="{!! url('/salemaster/collection?flag=filter') !!}"> Filter  </a>
					<?php 
					...
					?>
                    @if ($flags=='filter')
                           {!! Form::open(['url' => 'salemaster/cfilter', 'class' => 'form-horizontal']) !!}
