...
<style>
	...
	#inner { border:1px solid #300; min-height:60px; padding:10px; margin:3px; font-size:10px}
    ...
    <div class="table-responsive">
        ...
        <?php 
			...
			if (isset($data['acc_id']) && $data['acc_id']>0):
				...
				echo '<tr><td ><h2 class="pull-left rpt">Invoice</h2></td><td></td>
				...
				echo '<tr><td class="text-center" colspan="2"><h4 class="rpt">Invoice</h4><h5 ></h5></td></tr>';
			endif;
		...
		?>
            ...
            <table id="buyerinfo-table" class="table tables">
                ...
                @foreach($sale as $item)
					...
					$checkname=$item->check_note!='' ? $users[$item->check_id] : 'waiting';
					$apprname= '...';
					//$user=$item->user->name;
					$ttl='';
         	...
         	<div class="foo" style="padding:5px; ; font-size:10px">
