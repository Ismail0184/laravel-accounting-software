 ...
 <div class="box" >
    <div class="table-responsive">
        ...
        <?php 
			...
			$inventory = DB::table('acc_coas')->where('com_id',$com_id)->where('name','Inventory')->first();
			$inventory_id=''; isset($inventory) && $inventory->id> 0 ? $inventory_id=$inventory->id : $inventory_id='';
		...
		?>
            ...
            <table id="buyerinfo-table" class="table table-bordered table-striped">
                <thead>
                <tr><td colspan="8"><a href="{!! url('/salemaster/report?flag=filter') !!}"> Filter  </a>
					<?php 
                ...
                @foreach($sale as $item)
					...
					?>
                        ...
                        @endforeach  
                        	...
                        	{!! Form::hidden('acc_id', $inventory_id, ['class' => 'form-control']) !!}
