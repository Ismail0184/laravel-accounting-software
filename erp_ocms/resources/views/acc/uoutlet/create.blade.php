...
@section('htmlheader_title', $langs['create_new'] . ' Uoutlet')

@section('contentheader_title', $langs['create_new'] . ' Uoutlet')

@section('main-content')

    {!! Form::open(['route' => 'uoutlet.store', 'class' => 'form-horizontal uoutlet']) !!}
