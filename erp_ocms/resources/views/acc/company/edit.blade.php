...
@section('htmlheader_title', $langs['edit'] . ' Company')

@section('contentheader_title', $langs['edit'] . ' Company')

@section('main-content')
    
    {!! Form::model($company, ['route' => ['company.update', $company->id], 'method' => 'PATCH', 'class' => 'form-horizontal company']) !!}
