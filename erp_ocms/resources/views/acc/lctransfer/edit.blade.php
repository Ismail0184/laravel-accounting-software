...
@section('htmlheader_title', $langs['edit'] . ' Lctransfer')

@section('contentheader_title', $langs['edit'] . ' Lctransfer')

@section('main-content')
    
    {!! Form::model($lctransfer, ['route' => ['lctransfer.update', $lctransfer->id], 'method' => 'PATCH', 'class' => 'form-horizontal lctransfer']) !!}
					...
					<div class="form-group">
                        {!! Form::label('crateto', $langs['crateto'], ['class' => 'col-sm-3 control-label']) !!}
                        <div class="col-sm-6"> 
                            {!! Form::text('crateto', null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
					<div class="form-group">
