...
@section('contentheader_title', ' Project Planning')
    ...
    <div class="table-responsive">
		...
		?>
            ...
            <table id="buyerinfo-table" class="table table-bordered">
                <thead>
                <tr><td colspan="6"><a href="{!! url('/pplanning/report?flag=filter') !!}"> Filter  </a>
					<?php 
					...
					?>
                    @if ($flags=='filter')
                           {!! Form::open(['url' => 'pplanning/filter', 'class' => 'form-horizontal']) !!}
