...
@section('htmlheader_title', $langs['edit'] . ' B2b')

@section('contentheader_title', $langs['edit'] . ' B2b')

@section('main-content')
    <?php $audit ="";?>
    {!! Form::model($b2b, ['route' => ['b2b.update', $b2b->id], 'method' => 'PATCH', 'class' => 'form-horizontal b2b']) !!}
