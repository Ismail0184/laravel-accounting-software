...
@section('htmlheader_title', $langs['edit'] . ' Warehouse')

@section('contentheader_title', $langs['edit'] . ' Warehouse')

@section('main-content')
    
    {!! Form::model($warehouse, ['route' => ['warehouse.update', $warehouse->id], 'method' => 'PATCH', 'class' => 'form-horizontal warehouse']) !!}
