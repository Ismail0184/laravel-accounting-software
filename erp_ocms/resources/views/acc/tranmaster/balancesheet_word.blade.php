    ...
    <div class="table-responsive">
        ...
        <?php 
			...
			echo '<tr><td ><h3 class="pull-left">Group Account</h3></td>
				...
				echo '<tr><td class="text-center" colspan="2"><h3>Balance Sheet</h3><h5 >'.$data['dto'].'</h5></td></tr>';
			endif;
...
-->                                   <!--------------first------------------>
                        ...
                        <tr>
							...
							<?php 
							 $assets=''; $asset!='' ? $assets=number_format($asset,2) : $assets=''; 
							...
							//=================================================
								...
								$tra=DB::table('acc_coas')->where('com_id',$com_id)->where('name','Trading Accounting')->first();
