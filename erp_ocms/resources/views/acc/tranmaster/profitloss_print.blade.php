...
@section('main-content')
 ...
 <div class="box" >
    <div class="table-responsive">
        <table  width="100% class="tables table">
        <?php 
			Session::has('com_id') ? 
			...
			echo '<tr><td ><h3 class="pull-left">Group Account</h3></td>
				...
				echo '<tr><td class="text-center" colspan="2"><h4 class="rpt">Profit and Loss Account</h4><h5 class="tdate">'.$data['dfrom'].' to '.$data['dto'].'</h5></td></tr>';
			endif;
			
		?>
		</table>
            <table id="buyerinfo-table" class="tables table" width="100%">
                <thead>
                    <tr>
                                                    ...
                                                    ?>
													  ...
													  // find child account has or not?
														...
														if (isset($item->atype) && $item->atype=='Group' && $flag==1):
														 ?>
														 <tr>
															<td style="padding-left:90px">{{ $item->name }}</a></td>
															<td id="cur"></td><td class=" text-right"></td>
															<td id="cur"></td><td class=" text-right"></td>
