...
@section('htmlheader_title', 'Distribution')
...
@section('main-content')
 ...
 <div class="box" >
    <div class="table-responsive">
            ...
            <a href="{{ url('tranmaster/pldistribution_print') }}" title="{{ $langs['print'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-print"></i></a>
            <a href="{{ url('tranmaster/pldistribution_pdf') }}" title="{{ $langs['download'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-download"></i></a>
            <a href="{{ url('tranmaster/pldistribution_pdf') }}" title="{{ $langs['pdf'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-file-pdf-o"></i></a>
            <a href="{{ url('tranmaster/pldistribution_excel') }}" title="{{ $langs['excel'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-file-excel-o"></i></a>
            <a href="{{ url('tranmaster/pldistribution_csv') }}" title="{{ $langs['csv'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-file-excel-o"></i></a>
            <a href="{{ url('tranmaster/pldistribution_word') }}" title="{{ $langs['word'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-file-word-o"></i></a>
        ...
        <?php 
			...
			echo '<tr><td ><h3 class="pull-left">Group Account</h3></td>
				...
				echo '<tr><td class="text-center" colspan="2"><h4>Profit and Loss Distribution Account</h4><h5 >'.$data['dfrom'].' to '.$data['dto'].'</h5></td></tr>';
			endif;
