...
@section('main-content')
            <?php 
                ...
                <tr><th colspan="4"><h2><span class="pull-left com">{{ $com_name }}</span><span class="pull-right rpt">{{ $vn }}</span></h2></th></tr>
                <tr><th colspan="4"><h3 class="text-center com">{{ $nam }} {{ $tranmaster->ttype }}</h3></th></tr>
                <tr>
                <th id="lebel">{{ $langs['vnumber'] }} :</th><th>{{ $tranmaster->vnumber }}</th>
                <th  id="lebel">{{ $langs['tdate'] }} :</th><th id="lebel2">{{ $tranmaster->tdate }}</th>
                </tr>
                @if ($tranmaster->ttype!="Journal")
                <tr>
                    <th id="lebel" >{{ $langs['person'] }} :</th><th>{{ $tranmaster->person }}</th><th id="lebel">{{ $langs['tranwith_id'] }} :</th>
                    <th id="lebel2">{{ $tranwith_name }}</th>
            	</tr>
                @endif
        </table><br>
