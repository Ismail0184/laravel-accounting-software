...
@section('contentheader_title', 'Cash Flow Indirect Method')
    ...
    <div class="box">
        ...
        <div class="box-body">
            <table id="desigtn-table" class="table table-bordered table-striped">
                <thead>
                <tr><td colspan="8"><a href="{!! url('/trandetail/cashflowid?flag=filterid') !!}"> Filter  </a>
					<?php 
					...
					?>
                    @if ($flags=='filterid')
                           {!! Form::open(['url' => 'trandetail/filterid', 'class' => 'form-horizontal']) !!}
