        ...
        <div class="col-md-12">
            ...
            <table id="buyerinfo-table" class="table table-bordered table-striped">
                ...
                @endforeach
                    ...
                    <tr><td></td><td class="text-right">Advance For Expenses</td><td class="text-right">{{ $cb_afe }}</td></tr>
            ...
            <table id="buyerinfo-table" class="table table-bordered table-striped">
                ...
                <?php  
					...
					->where('acc_tranmasters.vnumber', $item->vnumber)->where('acc_id',$afe_id )->where('acc_trandetails.sh_id','>',0)->first();
					//
					
				?>
                    <td width="50" class="text-center">{{ $x }}</td>
                	<td><a href="{{ url('/tranmaster', $item->id) }}">
