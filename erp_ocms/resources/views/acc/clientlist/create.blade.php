...
@section('htmlheader_title', $langs['create_new'] . ' Clientlist')

@section('contentheader_title', $langs['create_new'] . ' Clientlist')

@section('main-content')

    {!! Form::open(['route' => 'clientlist.store', 'class' => 'form-horizontal clientlist']) !!}
