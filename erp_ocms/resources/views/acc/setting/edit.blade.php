...
@section('htmlheader_title', $langs['edit'] . ' Setting')

@section('contentheader_title', $langs['edit'] . ' Setting')

@section('main-content')
    
    {!! Form::model($setting, ['route' => ['setting.update', $setting->id], 'method' => 'PATCH', 'class' => 'form-horizontal setting']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::select('onem', array('' => 'Select ...', 'm1'=>'Accounting', 'all'=>'All Module'), null, ['class' => 'form-control', 'required', 'interger']) !!}
                        </div>    
                    </div>
					<div class="form-group">
