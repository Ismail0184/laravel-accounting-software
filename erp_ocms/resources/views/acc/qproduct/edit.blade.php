...
@section('htmlheader_title', $langs['edit'] . ' Qproduct')

@section('contentheader_title', $langs['edit'] . ' Quotation product')

@section('main-content')
    
    {!! Form::model($qproduct, ['route' => ['qproduct.update', $qproduct->id], 'method' => 'PATCH', 'class' => 'form-horizontal qproduct']) !!}
