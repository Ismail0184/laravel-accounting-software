...
@section('htmlheader_title', $langs['edit'] . ' Client')

@section('contentheader_title', $langs['edit'] . ' Client')

@section('main-content')
    
    {!! Form::model($client, ['route' => ['client.update', $client->id], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
