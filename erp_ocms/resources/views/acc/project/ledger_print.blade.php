    ...
    <div class="table-responsive">
        ...
        <?php 
			...
			if (isset($data['acc_id']) && $data['acc_id']>0):
				...
				echo '<tr><td class="text-center" colspan="2"><h4>General Ledger</h4><h5>Project Name: '.$pro_name.'</h5></td></tr>';
			endif;
                    ...
                    @if ($flags=='filter')
                           {!! Form::open(['url' => 'acc-project/prfilter', 'class' => 'form-horizontal']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6"> 
                                    {!! Form::select('pro_id',$projects , null, ['class' => 'form-control', 'id'=>'pro_id', 'required']) !!}
                                </div>    
                            </div>
                            <div class="form-group">
