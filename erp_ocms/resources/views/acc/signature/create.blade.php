...
@section('htmlheader_title', $langs['create_new'] . ' Signature')

@section('contentheader_title', $langs['create_new'] . ' Signature')

@section('main-content')

    {!! Form::open(['route' => 'signature.store', 'class' => 'form-horizontal signature']) !!}
