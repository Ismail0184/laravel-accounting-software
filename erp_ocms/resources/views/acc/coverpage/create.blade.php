...
@section('htmlheader_title', $langs['create_new'] . ' Coverpage')

@section('contentheader_title', $langs['create_new'] . ' Coverpage')

@section('main-content')

    {!! Form::open(['route' => 'coverpage.store', 'class' => 'form-horizontal coverpage']) !!}
