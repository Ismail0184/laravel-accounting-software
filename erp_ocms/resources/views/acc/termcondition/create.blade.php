...
@section('htmlheader_title', $langs['create_new'] . ' Termcondition')

@section('contentheader_title', $langs['create_new'] . ' Termcondition')

@section('main-content')

    {!! Form::open(['route' => 'termcondition.store', 'class' => 'form-horizontal termcondition']) !!}
