...
@section('htmlheader_title', $langs['create_new'] . ' Budget')

@section('contentheader_title', $langs['create_new'] . ' Budget')

@section('main-content')
    <?php $byear=date('Y'); //echo $byear; ?>

    {!! Form::open(['route' => 'budget.store', 'class' => 'form-horizontal']) !!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::text('byear', $byear, ['class' => 'form-control', 'required','number']) !!}
                        </div>    
                    </div>					
                    <div class="form-group">
