...
@section('contentheader_title', $langs['create_new'] . ' Pbudget')

@section('main-content')

    {!! Form::open(['route' => 'pbudget.store', 'class' => 'form-horizontal pbudget']) !!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::select('seg_id', array(''=> 'Select ...'), null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
					<div class="form-group">
