...
@section('main-content')
    ...
    {!! Form::model($salary, ['route' => ['salary.update', $salary->id], 'method' => 'PATCH', 'class' => 'form-horizontal salary']) !!}
					...
					<div class="form-group">
                        {!! Form::label('asalary', $langs['asalary'], ['class' => 'col-sm-3 control-label']) !!}
                        <div class="col-sm-6"> 
                            {!! Form::text('asalary', null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
					<div class="form-group">
                        {!! Form::label('loan', $langs['loan'], ['class' => 'col-sm-3 control-label']) !!}
                        <div class="col-sm-6"> 
                            {!! Form::text('loan', null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
