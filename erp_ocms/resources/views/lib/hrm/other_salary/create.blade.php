...
@section('htmlheader_title', $langs['create_new'] . ' Other Salary')

@section('contentheader_title', $langs['create_new'] . ' Other Salary')

@section('main-content')

    {!! Form::open(['route' => 'other-salary.store', 'class' => 'form-horizontal']) !!}
