...
@section('htmlheader_title', $langs['edit'] . ' Govt. Salary')

@section('contentheader_title', $langs['edit'] . ' Govt. Salary')

@section('main-content')
    
    {!! Form::model($govt_salary, ['route' => ['govt-salary.update', $govt_salary->id], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
