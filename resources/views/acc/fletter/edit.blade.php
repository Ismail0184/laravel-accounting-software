...
@section('htmlheader_title', $langs['edit'] . ' Fletter')

@section('contentheader_title', $langs['edit'] . ' Forwarding letter')

@section('main-content')
    
    {!! Form::model($fletter, ['route' => ['fletter.update', $fletter->id], 'method' => 'PATCH', 'class' => 'form-horizontal fletter']) !!}
