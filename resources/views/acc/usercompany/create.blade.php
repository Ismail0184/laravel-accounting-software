...
@section('htmlheader_title', $langs['create_new'] . ' Usercompany')

@section('contentheader_title', $langs['create_new'] . ' Usercompany')

@section('main-content')

    {!! Form::open(['route' => 'usercompany.store', 'class' => 'form-horizontal usercompany']) !!}
