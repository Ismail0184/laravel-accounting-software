...
@section('htmlheader_title', 'Manufacturing Account')
...
@section('main-content')
 ...
 <div class="box" >
    <div class="table-responsive">
            ...
            <a href="{{ url('tranmaster/manufacturing_print') }}" title="{{ $langs['print'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-print"></i></a>
            <a href="{{ url('tranmaster/manufacturing_pdf') }}" title="{{ $langs['download'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-download"></i></a>
            <a href="{{ url('tranmaster/manufacturing_pdf') }}" title="{{ $langs['pdf'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-file-pdf-o"></i></a>
            <a href="{{ url('tranmaster/manufacturing_excel') }}" title="{{ $langs['excel'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-file-excel-o"></i></a>
            <a href="{{ url('tranmaster/manufacturing_csv') }}" title="{{ $langs['csv'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-file-excel-o"></i></a>
            <a href="{{ url('tranmaster/manufacturing_word') }}" title="{{ $langs['word'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-file-word-o"></i></a>
        ...
        <?php 
			...
			echo '<tr><td ><h3 class="pull-left">Group Account</h3></td>
				...
				echo '<tr><td class="text-center" colspan="2"><h4>Manufacturing Account</h4><h5 >'.$data['dfrom'].' to '.$data['dto'].'</h5></td></tr>';
			endif;
		...
		?>
            ...
            <table id="buyerinfo-table" class="table table-bordered ">
                <thead>
                <tr><td colspan="8"><a href="{!! url('/tranmaster/manufacturing?flag=filter') !!}"> Filter  </a>
                <?php 
					...
					?>
                    @if ($flags=='filter')
                           {!! Form::open(['url' => 'tranmaster/mfilter', 'class' => 'form-horizontal']) !!}
...
-->                                   <!--------------first------------------>
                        ...
                        <?php
							...
							?>
									<tr id='cls'>
                                        <td class="text-right">Process Cost<br>(Transfered to Trading Account)</td>
                                        <td id="cur"></td><td class=" text-right"></td>
			...
			<div class="box-header">
                ...
                <tr><td class="text-left">Source: Transaction->Manufacturing Account</td><td class="text-right">Report generated by: {{ $user_name }}</td></tr>
                </table>
            </div><!-- /.box-header -->
        </div>
     </div>
