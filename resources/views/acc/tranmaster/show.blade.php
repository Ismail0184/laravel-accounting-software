...
@section('htmlheader_title', 'Transaction Details')
...
<?php 
	...
	$cur=DB::table('acc_currencies')->where('id',$tranmaster->currency_id)->first(); 
	$currency=''; isset($cur) && $cur->id > 0 ? $currency=$cur->name : $currency='';
	...
	$balance=DB::table('acc_trandetails')->where('com_id', $com_id)->where('acc_id',$tranmaster->tranwith_id)->where('sh_id',$tranmaster->sh_id)->sum('amount');
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>{{ $tranmaster->person }}</td>
                            			...
                            			<td>{{ $tran_with_name }} ({{ $blance }}) / @if(isset($tranmaster->subhead->name)){{ $tranmaster->subhead->name }}({{ $balance }}) @endif</td>
                        </tr>
                        <?php 
   			 ...
   			 <table class="table table-bordered">   
             	<tr>
                  ...
                  <?php
						...
						$acc_head=''; isset($coa) && $coa->id>0  ? $acc_head=$coa->name : $acc_head='' ; 
						...
						$proj_name='';
						if ($value->pro_id>0 ): 
							$proj = DB::table('acc_projects')->where('com_id',$com_id)->where('id',$value->pro_id)->first();
							isset($proj) && $proj->id > 0 ?   $acc_head = $acc_head.', Project of '.$proj->name : ''; 
						endif;
...
*/				  
                ...
                <ul class="navigation">
                    ...
                    <li>
                        <a data-toggle="tab" href="#reminder">
                            <span class="glyphicon glyphicon-plus"> Reminder</span>
                        </a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#condition">
                            <span class="glyphicon glyphicon-plus"> Condition</span>
                        </a>
                    </li>
                ...
                <div class="user-body">
                    <div class="tab-content">
                        ...
                        <div id="information" class="tab-pane active" >
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-6"> 
                                     ...
                                     {!! Form::hidden('shc_id', $tranmaster->sh_id) !!} 
						...
						<div id="reminder" class="tab-pane">
                            <div class="form-group">
                                {!! Form::label('rmndr_id', $langs['rmndr_id'], ['class' => 'col-sm-3 control-label']) !!}
                                <div class="col-sm-6"> 
                                    {!! Form::text('rmndr_id',  null, ['class' => 'form-control']) !!}
                                </div>    
                            </div>
                            <div class="form-group">
                                {!! Form::label('rmndr_note', $langs['rmndr_note'], ['class' => 'col-sm-3 control-label']) !!}
                                <div class="col-sm-6"> 
                                    {!! Form::text('rmndr_note', null, ['class' => 'form-control']) !!}
                                </div>    
                            </div>
                            <div class="form-group">
                                {!! Form::label('rmndr_date', $langs['rmndr_date'], ['class' => 'col-sm-3 control-label']) !!}
                                <div class="col-sm-6"> 
                                    {!! Form::text('rmndr_date', null, ['class' => 'form-control']) !!}
                                </div>    
                            </div>
                        </div>
	                    <!-- Condition-->                       
						<div id="condition" class="tab-pane">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6"> 
                                    {!! Form::text('mdeduction',  null, ['class' => 'form-control']) !!}
                                </div>    
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-3">
                                {!! Form::hidden('notes', null, ['class' => 'form-control', 'id'=>'notes']) !!}
    		...
    		{!! Form::model($tranmaster, ['route' => ['tranmaster.update', $tranmaster->id], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::textarea('note', null, ['class' => 'form-control', 'required','size' => '5x3', 'id'=>'note', 'onkeyup' => 'return sync();']) !!}
                            {!! Form::hidden('tmamount', $ttl, ['class' => 'form-control', 'required', 'readonly']) !!}
                        </div>    
                    </div>  
                    <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-3">
                                {!! Form::submit($langs['close'], ['class' => 'btn btn-primary form-control']) !!}
                            </div>    
                    </div>                    
    		{!! Form::close() !!}
...
{ 
  ...
  var n2 = document.getElementById('notes');
  n2.value = n1.value;
}
</script>
...
jQuery(document).ready(function($) {        
		...
		$( "#rmndr_date" ).datepicker({ dateFormat: "yy-mm-dd" }).val();
