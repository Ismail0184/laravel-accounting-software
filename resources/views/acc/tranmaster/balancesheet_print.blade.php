...
<style>
	...
	#dt { width:15%;} 
	#nt { width:30%; } 
	#cls { font-size:12px; font-weight:bold;}
	#top { border-top: 1px double black; border-botto,: 1px solid black;}
	#grp { font-size:12px; font-weight:bold;}
 ...
 <div class="box" >
    <div class="table-responsive">
        ...
        <?php
			...
			// for single account
			echo '<tr><td ><h3 class="pull-left rpt">Group Account</h3></td>
				<td class="text-right" ><h3 aling="right" class="tdate">'.$acccoa[$data['acc_id']].'</h3><h5 >'.$data['dto'].'</h5></td></tr>';
			else:
				// for multiple account
				echo '<tr><td class="text-center rpt" colspan="2"><h4 class="rpt">Balance Sheet</h4><h5 class="tdate">'.$data['dto'].'</h5></td></tr>';
			endif;

		?>
		</table>
            <table id="buyerinfo-table" class="tables">
                <thead>
                    <tr>
