...
@section('htmlheader_title', $langs['create_new'] . ' Mteam')

@section('contentheader_title', $langs['create_new'] . ' Mteam')

@section('main-content')

    {!! Form::open(['route' => 'mteam.store', 'class' => 'form-horizontal mteam']) !!}
