...
@section('htmlheader_title', $langs['create_new'] . ' Frequisition')

@section('contentheader_title', $langs['create_new'] . ' Frequisition')

@section('main-content')

    {!! Form::open(['route' => 'frequisition.store', 'class' => 'form-horizontal']) !!}
    
    				<div class="form-group">
                        {!! Form::label('pr_id', $langs['pr_id'], ['class' => 'col-sm-3 control-label']) !!}
                        <div class="col-sm-6"> 
                            <!--{!! Form::text('name', null, ['class' => 'form-control', 'required']) !!}-->
                             {!! Form::select('pr_id', $prequisitions, null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
					<div class="form-group">
