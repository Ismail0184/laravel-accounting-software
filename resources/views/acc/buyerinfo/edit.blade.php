...
@section('htmlheader_title', $langs['edit'] . ' Buyer')

@section('contentheader_title', $langs['edit'] . ' Buyer')

@section('main-content')
    
    {!! Form::model($buyerinfo, ['route' => ['buyerinfo.update', $buyerinfo->id], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::text('phone', null, ['class' => 'form-control', 'required', 'maxlength' => 40,]) !!}
                        </div>    
                    </div>
					<div class="form-group">
