...
@section('htmlheader_title', $langs['edit'] . ' Orderinfo')

@section('contentheader_title', $langs['edit'] . ' Order information')

@section('main-content')
    
    {!! Form::model($orderinfo, ['route' => ['orderinfo.update', $orderinfo->id], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::text('ordernumber', null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
                    <div class="form-group">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::text('orderqty', null, ['class' => 'form-control', 'number' ]) !!}
                        </div>    
                    </div>
					<div class="form-group">
