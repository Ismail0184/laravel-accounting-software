...
@section('htmlheader_title', $langs['edit'] . ' Style')

@section('contentheader_title', $langs['edit'] . ' Style')

@section('main-content')
    
    {!! Form::model($style, ['route' => ['style.update', $style->id], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
