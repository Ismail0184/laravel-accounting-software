...
@section('htmlheader_title', $langs['create_new'] . ' Quotation')

@section('contentheader_title', $langs['create_new'] . ' Quotation')

@section('main-content')

    {!! Form::open(['route' => 'quotation.store', 'class' => 'form-horizontal quotation']) !!}
