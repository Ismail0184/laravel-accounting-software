...
@section('htmlheader_title', $langs['edit'] . ' Lcimport')
@section('contentheader_title', $langs['edit'] . ' Lcimport')

@section('main-content')
    
    {!! Form::model($lcimport, ['route' => ['lcimport.update', $lcimport->id], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::text('lcdate', null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::text('expdate', null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::select('currency_id', array('' => 'Select ...', 1 => 'DOLLAR', 2 => 'EURO', 3=>'Taka'), null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
