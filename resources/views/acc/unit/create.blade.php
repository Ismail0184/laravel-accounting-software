...
@section('htmlheader_title', $langs['create_new'] . ' Unit')

@section('contentheader_title', $langs['create_new'] . ' Unit')

@section('main-content')

    {!! Form::open(['route' => 'acc-unit.store', 'class' => 'form-horizontal unit']) !!}
