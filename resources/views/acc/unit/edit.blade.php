...
@section('htmlheader_title', $langs['edit'] . ' Unit')

@section('contentheader_title', $langs['edit'] . ' Unit')

@section('main-content')
    
    {!! Form::model($unit, ['route' => ['acc-unit.update', $unit->id], 'method' => 'PATCH', 'class' => 'form-horizontal unit']) !!}
