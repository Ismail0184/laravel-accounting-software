...
@section('htmlheader_title', $langs['create_new'] . ' Purchasedetail')

@section('contentheader_title', $langs['create_new'] . ' Purchasedetail')

@section('main-content')

    {!! Form::open(['route' => 'purchasedetail.store', 'class' => 'form-horizontal']) !!}
