...
@section('htmlheader_title', $langs['edit'] . ' Project')

@section('contentheader_title', $langs['edit'] . ' Project')

@section('main-content')
    
    {!! Form::model($project, ['route' => ['acc-project.update', $project->id], 'method' => 'PATCH', 'class' => 'form-horizontal project']) !!}
					...
					<div class="form-group">
                        {!! Form::label('fdate', $langs['fdate'], ['class' => 'col-sm-3 control-label']) !!}
                        <div class="col-sm-6"> 
                            {!! Form::text('fdate', null, ['class' => 'form-control', 'required', 'date']) !!}
                        </div>    
                    </div>
