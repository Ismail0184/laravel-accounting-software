...
@section('htmlheader_title', $langs['edit'] . ' Audit')

@section('contentheader_title', $langs['edit'] . ' Audit')
...
@section('main-content')
    ...
    {!! Form::model($audit, ['route' => ['audit.update', $audit->id], 'method' => 'PATCH', 'class' => 'form-horizontal audit']) !!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::select('audit_action', array( ''=>'select ...', '1'=>'Audit Claim', '2'=>'Explain'), null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
<!--					<div class="form-group">
