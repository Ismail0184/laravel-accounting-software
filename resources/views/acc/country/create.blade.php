...
@section('htmlheader_title', $langs['create_new'] . ' Country')

@section('contentheader_title', $langs['create_new'] . ' Country')

@section('main-content')

    {!! Form::open(['route' => 'country.store', 'class' => 'form-horizontal country']) !!}
