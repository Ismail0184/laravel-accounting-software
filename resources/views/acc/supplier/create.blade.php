...
@section('htmlheader_title', $langs['create_new'] . ' Supplier')

@section('contentheader_title', $langs['create_new'] . ' Supplier')
...
@section('main-content')
    ...
    {!! Form::open(['route' => 'supplier.store', 'class' => 'form-horizontal']) !!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6"> 
                            {!! Form::text('skype', null, ['class' => 'form-control', 'maxlength'=>60]) !!}
                        </div>    
                    </div>
