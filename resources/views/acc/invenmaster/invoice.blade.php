...
<style>
 ...
 <div class="box" >
        <div class="box-header">
            ...
            <a href="{{ url('invenmaster/invoice_print') }}" title="{{ $langs['print'] }}" class="btn btn-primary pull-right btn-sm trash-btn"><i class="fa fa-print"></i></a>
    ...
    <div class="table-responsive">
        ...
        <?php 
			...
			if (isset($data['acc_id']) && $data['acc_id']>0):
				...
				echo '<tr><td ><h2 class="pull-left title">Invoice</h2></td><td></td>
				<td class="text-right"  id="td"><h4 aling="right">Invoice No: '.$sales_invoice.'</h4><h4>Date: '.$sales_date.'</h4></td></tr>';
			else:
				// for multiple account
				echo '<tr><td class="text-center ttle" colspan="2"><h4>Invoice</h4><h5 ></h5></td></tr>';
			endif;
		...
		?>
            ...
            <table id="buyerinfo-table" class="table">
                <thead>
                 <tr><td colspan="6"><a href="{!! url('/invenmaster/invoice?flag=filter') !!}"> Filter  </a>
					<?php 
					...
					?>
                    @if ($flags=='filter')
                           {!! Form::open(['url' => 'invenmaster/inifilter', 'class' => 'form-horizontal']) !!}
                 ...
                 <tr class="underline"><td colspan="6"> Address: {{ $client_address }}</td></tr> 
                    <tr>
                        ...
                        <th class="col-md-2 text-right" >Total Taka</th>
                    </tr>
                </thead>
                <tbody>
				{{-- */$x=0;/* --}}
                ...
                @foreach($sale as $item)
					...
					?>
                        ...
                        <tr><td colspan="8" class=" text-left wordc">Inwords (Taka) : {{ Terbilang::make($ttl) }}</td></tr> 
