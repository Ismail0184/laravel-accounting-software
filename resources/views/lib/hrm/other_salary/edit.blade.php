...
@section('htmlheader_title', $langs['edit'] . ' Other Salary')

@section('contentheader_title', $langs['edit'] . ' Other Salary')

@section('main-content')
    
    {!! Form::model($other_salary, ['route' => ['other-salary.update', $other_salary->id], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
