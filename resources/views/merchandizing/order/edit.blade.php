...
@section('htmlheader_title', $langs['edit'] . ' Order')

@section('contentheader_title', $langs['edit'] . ' Order')
...
@section('main-content')
 ...
 <div class="box">
    ...
    {!! Form::model($order, ['route' => ['order.update', $order->id], 'method' => 'PATCH', 'class' => 'form-horizontal order']) !!}
    
 			<div class="form-group col-sm-6">
    				<div class="form-group col-sm-12">
                        {!! Form::label('jobno', $langs['jobno'], ['class' => 'col-sm-3 control-label']) !!}
                        <div class="col-sm-6"> 
                            {!! Form::text('jobno', null, ['class' => 'form-control', 'required']) !!}
                        </div>    
                    </div>
					<div class="form-group col-sm-12">
        	...
        	<div class="form-group col-sm-6">
					...
					<div class="form-group col-sm-12">
                        {!! Form::label('commercial', $langs['commercial'], ['class' => 'col-sm-3 control-label']) !!}
                        <div class="col-sm-6"> 
                            {!! Form::text('commercial', null, ['class' => 'form-control', 'required']) !!}
                        </div> 
                    </div>
