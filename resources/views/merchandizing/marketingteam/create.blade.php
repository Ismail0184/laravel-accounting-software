...
@section('htmlheader_title', $langs['create_new'] . ' Marketingteam')

@section('contentheader_title', $langs['create_new'] . ' Marketingteam')

@section('main-content')

    {!! Form::open(['route' => 'marketingteam.store', 'class' => 'form-horizontal marketingteam']) !!}
