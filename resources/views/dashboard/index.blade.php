...
<style>
	...
	.panel-heading { margin:0px; padding:0px; height:45px}
        ...
        <?php 
			...
			Session::has('topsheet') ? $topsheet=Session::get('topsheet') : $topsheet='' ;  //echo Session::get('topsheet').'osama';
...
<div class="container">
        ...
        <div class="panel-heading"><h3 style="margin:0px; padding:0px"><span class="pull-left">{{ $com_name }}</span><span class="pull-right">
       @if($topsheet==1)
        Hi, <a href="{{ url('/dashboard/topsheet') }}">{{ $user_name }}</a>
       @else
        Hi, {{ $user_name }}
